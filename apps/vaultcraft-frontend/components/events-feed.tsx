  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-3 mb-2">
        <label className="text-xs flex items-center gap-1"><input type="checkbox" checked={filterExec} onChange={(e) => setFilterExec(e.target.checked)} /> exec</label>
        <label className="text-xs flex items-center gap-1"><input type="checkbox" checked={filterFill} onChange={(e) => setFilterFill(e.target.checked)} /> fill</label>
        <label className="text-xs flex items-center gap-1"><input type="checkbox" checked={filterOther} onChange={(e) => setFilterOther(e.target.checked)} /> other</label>
        <label className="text-xs flex items-center gap-1 ml-auto"><input type="checkbox" checked={autoScroll} onChange={(e) => setAutoScroll(e.target.checked)} /> auto‑scroll</label>
      </div>
